<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Auth_WebForms_Connected.Login" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Login - Connection-Oriented Auth System</title>
                ...
                <div class="col-md-5">
                    <div class="card shadow-lg">
                        <div class="card-header bg-success text-white text-center py-4">
                            ...
                            <h3>Connection-Oriented Auth</h3>
                            <p class="mb-0">ADO.NET Connected Architecture</p>
                        </div>
