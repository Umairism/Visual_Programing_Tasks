<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductAdd.aspx.cs" Inherits="DbCon_CRUD.Products.ProductAdd" %>
                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        <div class="card-header bg-success text-white">
                            ...
                            <small>Using DbCon.ExecuteScalar() for INSERT</small>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <asp:TextBox ID="txtStock" runat="server" CssClass="form-control" TextMode="Number" Text="0" />
